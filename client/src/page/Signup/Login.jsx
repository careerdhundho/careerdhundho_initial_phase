   ...
   <>
    ...
    <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <a href="#" onClick={()=>{navigate("/signup")}} class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign up</a>
