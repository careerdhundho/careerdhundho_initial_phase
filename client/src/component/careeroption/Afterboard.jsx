...
export default function Podcaste() {
  return (
    <div className="2xl:mx-auto 2xl:container flex justify-center">
      <div className="2xl:px-20 px-6 py-12 w-full lg:w-11/12">
        ...
        >
          <div className="js-flickity flex justify-center items-center">
            ...
            <Slider>
              <Slide index={0}>
                <div className="gallery-cell lg:mr-7 mr-6 lg:w-1/2 sm:w-96 w-full h-1/6">
            ...
            <Slider className="carousel__sliderLarge">
              <Slide className="carousel__inner-slideLarge" index={0}>
                <div className="gallery-cell w-full h-full ">
                  <div className="relative w-full h-full  lg:block hidden bg-btn-color">
                
                  <img
                      src="  https://media.geeksforgeeks.org/auth-dashboard-uploads/learn2.png"
                      alt="chairs"
                      className="object-center object-cover w-full h-full "
                    />
                    <div className="pl-6 pb-6 lg:pl-8 lg:pb-8 absolute left-0 top-0">
                      <h1 className="text-xl leading-5 lg:text-2xl lg:leading-normal font-medium text-black">
                       B.Tech
                      </h1>
                    </div>
